(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                nouislider.create(item, {
                    start: [ Number(fromValue.value).toFixed(1), Number(toValue.value).toFixed(1) ],
                    connect: true,
                    tooltips: [ true, true ],
                    range: {
        ...
        da.init();
        document.addEventListener("click", documentAcitons);
